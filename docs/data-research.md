...
## Access policy review (2026-09-07)

The previous 2026-08-21 assessment is superseded by the current
[source-policy review](../pipeline/scraper/README.md#source-policy-review-2026-09-07).
Public disclosure is not permission to ignore robots.txt or reuse restrictions.
Automated lobbying retrieval was removed; WisconsinEye, FollowTheMoney, and
logo retrieval are paused pending the approval/review described there.
The source descriptions below are research notes, not collection authorization.
